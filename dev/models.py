...
class WideResNet(ResNet):
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False, groups=1, width_per_group=64,
                 replace_stride_with_dilation=None, norm_layer=None,target_dim=384):
        super(WideResNet, self).__init__(block, layers, num_classes, zero_init_residual, groups, width_per_group,
...
def wide_resnet101_2(arch, pretrained=False, progress=True, **kwargs):
    ...
    return _resnet(url, Bottleneck, [3, 4, 23, 3], pretrained, progress, **kwargs)
